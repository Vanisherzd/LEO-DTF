...
\cite{todo_doppler_positioning}; these methods require many passes and
...
\cite{todo_ntn_positioning}.  Oscillator imperfections in low-cost IoT
devices are identified as a major practical barrier, with CFO and drift
needing explicit estimation \cite{todo_oscillator_nuisance}.
