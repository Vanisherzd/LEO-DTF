...
\begin{itemize}
  \item \textbf{LR1121/STM32 packet source}: The Semtech LR1121 transceiver%~\cite{todo_lr1121}
        is configured in transmit-only mode (LR-FHSS or LoRa%~\cite{todo_lora_phy})
  ...
  \item \textbf{USRP B210}%~\cite{todo_usrp_b210}: A Software-Defined Radio (SDR) front-end captures
