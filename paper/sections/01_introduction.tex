...
\begin{itemize}
  ...
  \item A reproducible synthetic-pass and Monte Carlo evaluation pipeline
        that produces posterior heatmaps, error statistics, and CRLB
        sensitivity diagnostics without requiring satellite over-the-air
        data.
  \item A trace-driven hardware-in-the-loop (HIL) validation plan using an
        LR1121/STM32 packet source and a USRP B210 capture front-end,
